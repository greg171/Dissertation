        ...
        die("Query Failed ".$conn->error);
         ...
         while ($row = $result->fetch_assoc()) {
             ...
             if ($newusername == $checkUser) {
                 ...
                 if($duplicate == 0){
                 $sql = "INSERT INTO `Advisors` ( `Username`, `Password`, `Name`, `Number of Seekers`) VALUES  ('$newusername','$newpassword','$newname', '$newage')";
...
<div class="buttons">
    <a href="advisor.php"><input type="submit" value="Back To Login" id="runbuttons"></a>
</div>
